...
/* harmony import */ var _interfaces_user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../interfaces/user.service */ "./src/app/interfaces/user.service.ts");
...
let AddUserComponent = class AddUserComponent {
    constructor(fb, userServ, router, toastr) {
        this.fb = fb;
        ...
        let formControls = {
            firstname: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]('', [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern("[a-z .'_]+")
            ]),
    ...
    addUser() {
        ...
        let user = new _interfaces_user_service__WEBPACK_IMPORTED_MODULE_1__["User"](data.firstname, data.lastname, null, data.phone);
        this.isLoading = true;
...
/* harmony import */ var _people_list_people_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./people-list/people-list.component */ "./src/app/people-list/people-list.component.ts");
...
/* harmony import */ var _show_people_list_show_people_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./show-people-list/show-people-list.component */ "./src/app/show-people-list/show-people-list.component.ts");
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./auth.guard */ "./src/app/auth.guard.ts");
/* harmony import */ var _no_found_no_found_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./no-found/no-found.component */ "./src/app/no-found/no-found.component.ts");
...
/* harmony import */ var _people_list_people_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./people-list/people-list.component */ "./src/app/people-list/people-list.component.ts");
...
/* harmony import */ var _no_found_no_found_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./no-found/no-found.component */ "./src/app/no-found/no-found.component.ts");
/* harmony import */ var _show_people_list_show_people_list_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./show-people-list/show-people-list.component */ "./src/app/show-people-list/show-people-list.component.ts");
...
/* harmony import */ var _seletion_loader_seletion_loader_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./seletion-loader/seletion-loader.module */ "./src/app/seletion-loader/seletion-loader.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _people_list_people_list_component__WEBPACK_IMPORTED_MODULE_10__["PeopleListComponent"],
            ...
            _no_found_no_found_component__WEBPACK_IMPORTED_MODULE_14__["NoFoundComponent"],
            _show_people_list_show_people_list_component__WEBPACK_IMPORTED_MODULE_15__["ShowPeopleListComponent"],
        ...
        imports: [
            ...
            _seletion_loader_seletion_loader_module__WEBPACK_IMPORTED_MODULE_18__["SeletionLoaderModule"]
        ],
        providers: [],
...
class User {
    constructor(firstname, lastname, email, phone, password, _id) {
...
let LoginComponent = class LoginComponent {
    constructor(fb, userSrve, router, toster) {
        this.fb = fb;
    ...
    loginForms() {
        ...
        let user = new _interfaces_user_service__WEBPACK_IMPORTED_MODULE_1__["User"](null, null, data.email, null, data.password, null);
        this.isLoading = true;
...
let NavbarComponent = class NavbarComponent {
    constructor(router, userServ, toster) {
        this.router = router;
        this.userServ = userServ;
        this.toster = toster;
    }
...
NoFoundComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-no-found',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./no-found.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/no-found/no-found.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./no-found.component.scss */ "./src/app/no-found/no-found.component.scss")).default]
    })
], NoFoundComponent);
...
let PeopleListComponent = class PeopleListComponent {
    constructor(userService, route, toster) {
    ...
    delete(person) {
        ...
        this.userService.deleteUser(person._id).subscribe(res => {
...
PeopleListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./people-list.component.scss */ "./src/app/people-list/people-list.component.scss")).default]
    })
], PeopleListComponent);
...
let RegisterComponent = class RegisterComponent {
    constructor(fb, userServ, router, toster) {
        this.fb = fb;
        this.userServ = userServ;
        this.router = router;
        this.toster = toster;
        ...
        let formControls = {
            firstname: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern("[a-z .'_]+")
            ]),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeletionLoaderComponent", function() { return SeletionLoaderComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let SeletionLoaderComponent = class SeletionLoaderComponent {
    constructor() { }
    ngOnInit() {
    }
    getMyStyle() {
...
], SeletionLoaderComponent.prototype, "Cwidth", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SeletionLoaderComponent.prototype, "Cheight", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SeletionLoaderComponent.prototype, "circle", void 0);
SeletionLoaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-seletion-loader',
        template: `   
      <div [ngStyle]="getMyStyle()" class="skelt-load loader"></div>
  `,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./seletion-loader-module.component.scss */ "./src/app/seletion-loader/seletion-loader-module.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeletionLoaderModule", function() { return SeletionLoaderModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _seletion_loader_module_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./seletion-loader-module.component */ "./src/app/seletion-loader/seletion-loader-module.component.ts");




let SeletionLoaderModule = class SeletionLoaderModule {
};
SeletionLoaderModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowPeopleListComponent", function() { return ShowPeopleListComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ShowPeopleListComponent = class ShowPeopleListComponent {
    constructor(userServ, activateRouter) {
        this.userServ = userServ;
...
ShowPeopleListComponent.ctorParameters = () => [
    { type: _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
ShowPeopleListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-show-people-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./show-people-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/show-people-list/show-people-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./show-people-list.component.scss */ "./src/app/show-people-list/show-people-list.component.scss")).default]
    })
...
/* harmony import */ var _interfaces_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../interfaces/user.service */ "./src/app/interfaces/user.service.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
...
let UpdateUserComponent = class UpdateUserComponent {
    constructor(fb, activateRouter, userServ, toastr, router) {
        this.fb = fb;
        this.activateRouter = activateRouter;
        this.userServ = userServ;
        this.toastr = toastr;
        ...
        let formControls = {
            firstname: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern("[a-z .'_]+")
            ]),
            ...
            phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(11),
    ...
    updateUser() {
        ...
        let userID = this.activateRouter.snapshot.params.id;
        this.isLoading = true;
        let user = new _interfaces_user_service__WEBPACK_IMPORTED_MODULE_5__["User"](data.firstname, data.lastname, null, data.phone, null, userID);
...
UpdateUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./update-user.component.scss */ "./src/app/update-user/update-user.component.scss")).default]
    })
], UpdateUserComponent);
...
module.exports = __webpack_require__(/*! D:\Project\people-list\src\main.ts */"./src/main.ts");
